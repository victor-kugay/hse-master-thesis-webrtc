  ...
  methods: {
    ...
    screenShareToggle(e) {
      ...
      if (!App.screenShareEnabled) {
        ...
        document.getElementById(this.peerId + '_videoEnabled').style.visibility =
          'hidden';
      }
      screenMediaPromise
        .then((screenStream) => {
    ...
    updateUserData(key, value) {
      ...
      switch (key) {
        case 'audioEnabled':
          ...
          break;
        case 'videoEnabled':
          document.getElementById(this.peerId + '_videoEnabled').style.visibility = value
            ? 'hidden'
            : 'visible';
          break;
        case 'peerName':
    ...
    linkify(str) {
      return this.sanitizeString(str).replace(
        ...
        (match) => {
          ...
          displayURL =
            displayURL.length > 25 ? displayURL.substr(0, 25) + '&hellip;' : displayURL;
    ...
    handleIncomingDataChannelMessage(dataMessage) {
      switch (dataMessage.type) {
        ...
        case 'audioEnabled':
          ...
          break;
        case 'videoEnabled':
          document.getElementById(dataMessage.id + '_videoEnabled').style.visibility =
            dataMessage.message ? 'hidden' : 'visible';
          break;
        case 'peerName':
